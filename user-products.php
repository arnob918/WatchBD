...
session_start();
    ...
    $active_gender = $_GET['category'];
    $prods = getByGenderActive("products", $active_gender);
?>
...
<head>
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark navbar-bg-gradient py-3">
        <span>
            ...
            <a class="navbar-brand text-light font-rubik" href="categories.php">/ Categories</a>
            <a class="navbar-brand text-light font-rubik" href="">/ <?= $_GET['category'] ?></a>
        </span>
